                                                                    ...
                                                                    <form action="#">
                                                                        <div class="row">
                                                                            <table class="table">
                                                                                        ...
                                                                                        <td>
                                                                                            <div class="radio">
                                                                                                <label>
                                                                                                    ...
                                                                                                    <a href="E?nameVaccine=${nameVaccine}&nameHospital=${nameHospital}&date=${date}" style="color: white;">${date}</a>
                                                                                                </label>
                                                                                            </div>
                                                                                        </td>
                                                                                        <td>
                                                                                            <c:forEach items="${timeRanges}" var="timeRange">
                                                                                                <label>
                                                                                                    <input type="radio" name="time-range" value="${timeRange}" onclick="setTimeRange(${timeRange.id})">
                                                                                                    <a href="#" style="color: white;">${timeRange.startTime} - ${timeRange.endTime}</a>
                                                                                                </label>
                                                                                                <br>
                                                                                            </c:forEach>
                                                                                            ...
                                                                                            <script>
                                                                                                ...
                                                                                                function submitForm2(event, idVaccine, idHAP) {
                                                                                                    ...
                                                                                                    var url = "F?date=" + encodeURIComponent(date)
                                                                                ...
                                                                                <button type="button" onclick="submitForm2(event, ${idVaccine}, ${idHAP})">Submit</button>
                                                                            </table>
                                                                        </div>
                                                                    </form>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="input-group form-group">
                                                                            ...
                                                                            <input type="text" class="form-control"
                                                                                   name="name" value="<%= nameVaccine%>" readonly>
                                                                        </div>
                                                                        <div class="input-group form-group">
                                                                            <span class="input-group-addon"><i
                                                                                    ...
                                                                                    aria-hidden="true"></i></span>
                                                                            <input type="text" class="form-control"
                                                                                   name="name" value="<%= nameHospital%>" readonly>
                                                                        </div>
                                                                        <div class="input-group form-group">
                                                                            <span class="input-group-addon"><i
                                                                                    class="fa fa-user"
