...
//    public List<VaccineProvision> getVaccinePerHospital(String userId){
...
//    }
    ...
    public static void main(String[] args) {
        /*Test getIdVacByIdAP(int int1) ======> OK*/
//        int appointmentProvisionId = 5; // Replace with the actual appointment provision ID
//
//        int vaccineId = getIdVacByIdAP(appointmentProvisionId);
//        System.out.println("Vaccine ID: " + vaccineId);

        /*Test getVacTimeByIdAP(int int1) ======> OK*/
//        int int1 = 16;
//        java.sql.Date date = getVacTimeByIdAP(int1);
//        System.out.println("Time: " + date);

        /*Test getIdHosByIdAP(int int1) ======> OK*/
//        int int1 = 16;
//        int id = getIdHosByIdAP(int1);
//        System.out.println("ID Hap: " + id);  

        /*Test getAllVaccine() ======> OK*/
//        VaccineDAO dao = new VaccineDAO();
//        List<Vaccine> list = dao.getAllVaccine();
//        for(Vaccine o : list){
//            System.out.println(o);
//        }
        System.out.println(VaccineDAO.getIdVacByName("vaccine 2"));
